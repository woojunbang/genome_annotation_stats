...
# genome_annotation_stats version 2.
It can use for genome_annotation_report file

Yon can use command line as follows.

python genome_annotation_stats.py --genome yourgenome.fasta --annotation your_gtf --amino_acids protein.fasta --cds cds.fasta --format gtf
#it is developed for .gtf format braker output
